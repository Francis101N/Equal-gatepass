...
<head>
    ...
    <title>Add Security | Equal Gate-Pass </title>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        <div class="card border-0 rounded-4 shadow-sm overflow-hidden">
                            <div class="card-body p-4 p-md-5">
                                <div class="mb-4">
                                    <h2 class="fw-bold text-dark tracking-tight mb-1">Add Security Administrator</h2>
                                    <p class="text-muted small">Register new authorized Security profiles .</p>
                                </div>

                                <hr class="text-slate opacity-10 mb-4">

                                <!-- Action targets your processing engine file. Change to form handler path if decoupled -->
                                <form action="process-add-security.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    ...
                                    <div class="mt-5">
                                        <button type="submit" class="btn btn-brand-submit w-100 py-3 rounded-3 shadow-sm d-flex align-items-center justify-content-center gap-2">
                                            <i class="bi bi-shield-check-fill"></i> Save Security Record Profile
                                        </button>
                                    </div>
